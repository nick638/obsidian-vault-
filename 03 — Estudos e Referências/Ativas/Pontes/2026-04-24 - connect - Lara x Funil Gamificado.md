...
type: ponte
status: ativo
tags: [connect, lara, funil, gamificacao, b2b]
area: pesquisa
---

# [PONTE] Lara x Funil Gamificado

> Emulação conversacional substitui Forms. Lead se qualifica ativamente.

## 1. Conexão Tática
- **Problema:** Formulários de qualificação clássicos (Nome → Orçamento) geram atrito e drop-off.
