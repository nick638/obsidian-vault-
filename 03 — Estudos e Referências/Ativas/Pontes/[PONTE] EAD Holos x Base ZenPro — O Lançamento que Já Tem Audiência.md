...
type: ponte
status: ativo
tags: [nexus, ponte, ead, lancamento]
area: pesquisa
---

# [PONTE] EAD Holos x Base ZenPro

> Lançamento Interno pronto. A base é quente. O gatekeeper é o %.

## 1. Conexão Tática
- **Ativo de Dados:** 5.768 contatos no ZenPro (Hardcoded).
