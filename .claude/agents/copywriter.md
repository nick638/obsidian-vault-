...
- Tom: acolhedor, profissional, sem jargão técnico
- Gatilho principal: independência financeira + propósito
- Proibido: urgência falsa, promessa exagerada, "você merece"

### Mapa da Alma (quiz numerologia/HD)
- Público: pessoas em transição, buscando autoconhecimento e direção
- Tom: transformação, profundidade, sem esoterismo excessivo
- Gatilho principal: "por que as coisas não encaixam" → "agora faz sentido"

### Nicholas (serviços IA — B2B)
- Público: empreendedores, donos de escola/clínica, gestores
