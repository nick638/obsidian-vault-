...
status: rascunho
prioridade: media
quando_ler: "escada valor digital Holos (R$7,77→R$197→R$997→R$497), pré-requisitos (Lara no ar, negociação 15% EAD), Unimasso Trial no membership"
tags: [holos, digital, ead, infoproduto, escala]
---
...
```mermaid
graph TD
    A[Ads Meta] --> B[Página de Captura]
    B --> C[Low Ticket R$ 7,77]
    C --> D[Área de Membros]
    D --> E[Upsell: Cursos R$ 197]
    D --> F[Upsell: Membership R$ 997]
    F --> G[Fundo: Mentoria Presencial R$ 497]
```
